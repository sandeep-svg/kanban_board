...
Note: This app uses React + esbuild (NOT Inertia.js) due to Rails 8.1 compatibility. The Inertia.js gem requires Vite bundler and has known issues with Rails 8.1.
...
Auto-generated by Rails 8. Uses Ruby 3.3.6.